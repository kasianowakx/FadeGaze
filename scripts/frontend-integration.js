 ...
 * This file demonstrates how to integrate Fadegaze with a web frontend
 */

// For React/Vue/Angular applications
export class FadegazeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new FadegazeClient(provider, contractAddress);
